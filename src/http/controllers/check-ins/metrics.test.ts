...
describe('Obter métricas de check-ins', () => {
  ...
  it('should be able to get check-ins metrics', async () => {
    ...
    // Fazendo uma solicitação GET para o endpoint de métricas de check-ins, passando o token de acesso no header e a página como query
    ...
    expect(response.body.checkIns).toEqual(2) // Verifica se retornou 2
  })
})
